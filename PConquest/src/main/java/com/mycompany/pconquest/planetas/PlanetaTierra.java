...
import com.mycompany.pconquest.persona.GuerreroMole;
...
public class PlanetaTierra extends Planeta{
    ...
    public PlanetaTierra(String dueño,String nombre, int cantidadDeDinero, int cantidadDeConstructor, int cantidadDeNave, int cantidadDeGuerrero) {
   ...
   return random(50,50);
    ...
    public Guerrero[] getTipoGuerrero(int number) {
      Guerrero[] guerreroMole=new Guerrero[number];
        for (int i = 0; i < guerreroMole.length; i++) {
           guerreroMole[i]=new GuerreroMole();
